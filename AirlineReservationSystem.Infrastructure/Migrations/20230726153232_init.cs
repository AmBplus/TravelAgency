        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FlightInformation = table.Column<DateTime>(type: "datetime", nullable: false),
                    FlightStatus = table.Column<int>(type: "int", nullable: false),
                    AircraftID = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    StandardTicketPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Flights_FlightRoutes_FromId",
                        column: x => x.FromId,
                        principalTable: "FlightRoutes",
                        principalColumn: "RouteId",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Flights_FlightRoutes_ToId",
                        column: x => x.ToId,
                        principalTable: "FlightRoutes",
                        principalColumn: "RouteId",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BaggageId = table.Column<string>(type: "nvarchar(450)", nullable: false),
